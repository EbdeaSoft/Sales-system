...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">{{__('home.cash expenses')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">
    </span>
        </div>
    </div>
</div>
    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="{{ url(Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale().'/'. ($page = 'Expenses')) }}" method="POST" role="search" autocomplete="off">
                    {{ csrf_field() }}
...
<div class='row'>
    ...
    <div class="col">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="reasone" name="reasone" value="{{$data['recentsupllier']->name??''}}"
                                  >
                            </div>
                            <br>
