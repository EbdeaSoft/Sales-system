                ...
                <div class="card card-invoice">
                    <div class="card-body">
                        <div class="invoice-header">
                            <h5 class="invoice-title">  {{__('home.Receipt document')}}
 </h5>
								...
								<div class="table-responsive">
									<table id="example" class="table key-buttons text-md-nowrap">
										<thead>
                                            ...
                                            <th class="border-bottom-0"> {{__('home.CampanyName')}}</th>
...
<th></th>
                                        ...
                                        <td>{{$data['transaction']['camp_name']}}</td>
                                        <td>{{$data['transaction']['camp_phone']}}</td>
