        ...
        <div class="card">
                           ...
                           <table class="table table-hover" id="example1" data-page-length='50' style=" text-align: center;">
                                    ...
                                    <thead>
                                        ...
                                        <td >{{__('hr.phone')=='رقم الجوال' ? $employee->departments->name_ar:$employee->departments->name_en  }}</td>
                                        <td >{{ $employee->salary }}</td>
                                        <td >{{ $employee->old }}</td>
                                        <td >{{ __('hr.phone')=='رقم الجوال'&&$employee->sex=='male'?'ذكر':$employee->sex }}</td>
                                        <td > <a class="btn btn-sm btn-info" 
                                                href="{{'updateEmployee/'.$employee->id}}"><i class="las la-pen"></i>   </a>
</td>
