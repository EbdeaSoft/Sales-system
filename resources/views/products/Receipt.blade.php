    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="{{ url(Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale().'/'. ($page = 'Receipt')) }}" method="POST" role="search" autocomplete="off">
                    {{ csrf_field() }}
					<div class="row">
...
<label class="rdiobox"><input name="rdio" value="English" type="radio"><span> {{__('home.English')}}
                    ...
                    <div class="col">
                            ...
                            <div class="col">
                                ...
                                <input type="number" class="form-control " id="product_price_after_dis" name="product_price_after_dis"
                                     value=0
                                     >
                            </div> 
							...
							<div class="card-body">
                                ...
                                @foreach ($data['product'] as $product)
                                  ...
                                  @if($product->quantity>0)
                                    ...
                                    <a class="btn btn-success" href="{{ url('/' . ($page = 'printReceiptToStorehouse').'/'.$data['invoice_id']) }}">{{__('home.Print the invoice for receipt from the store')}}</a>
</div>
@endif
<br>
						</form>	
