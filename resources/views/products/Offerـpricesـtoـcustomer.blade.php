                    ...
                    <div class="row">
						...
						<div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                            ...
                            <select class="form-control select2 " name="clientNosearch"
                                required>
                                <option value="-" selected>
                                    {{ $supplierdata->clientNosearch ?? __('home.enterclientnumber') }}
                                </option>
						...
						<div class="col">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="notes"
                                    name="notes" title="يرجي ادخال ملاحظات  " value="{{$supplierdata->notes??null}}"
                                    >
                            </div>
...
<input type="number" hidden
 class="form-control" id="orderNo"name="orderNo"  value="{{$itemsRequest[0]->order_id??null}}">
</div>
                    ...
                    <table class="table table-hover" id="example1" data-page-length='50' style=" text-align: center;">
                                ...
                                @foreach ($itemsRequest as $product)
                                    ...
                                    <td>{{$product->productData->sale_price*0.15}}</td>
                                    <td>{{$product->quantity	}}</td>
                                    <td>{{$product->quantity*(($product->productData->sale_price*0.15)+$product->productData->sale_price)	}}</td>
                                    ...
                                    <div class="d-flex justify-content-center">
@if($itemsRequest!=null)
<a class="btn btn-success" href="{{ url('/' . ($page = 'print_order_perice_to_customer').'/'.$itemsRequest[0]->order_id) }}">  {{__('home.print')}}</a>
</div>
@endif
<br>
						<br/>
