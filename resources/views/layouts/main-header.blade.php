    ...
    <div class="container-fluid">
        <div class="main-header-left ">
            <div class="responsive-logo">
                <a href="https://ebdeasoft.com/"><img src="{{ URL::asset('assets/img/brand/logo.png') }}"
                ...
                <li class="">
                    <div class="dropdown  nav-itemd-none d-md-flex">
                        <a href="#" class="d-flex  nav-item nav-link pl-0 country-flag1" data-toggle="dropdown"
                            ...
                            <div class="my-auto">
                                <h6 class="mr-2 ml-2 my-auto"> {{ LaravelLocalization::getCurrentLocaleName() }} </h6>
                            </div>
                        </a>
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt=""
                            src="{{ URL::asset('storage/'.Auth::user()->profile_photo_path) }}"></a>
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <div class="main-img-user"><img alt="" src="{{ URL::asset('storage/'.Auth::user()->profile_photo_path) }}"
                                        class=""></div>
                        ...
                        <a class="dropdown-item" href="{{ route('profile.show') }}"><i class="bx bx-slider-alt"></i>{{__('auth.setting')}}</a>
