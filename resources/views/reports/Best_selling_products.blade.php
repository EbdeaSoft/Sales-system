    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="{{ url(Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale().'/'. ($page = 'Best_selling_products')) }}" method="POST" role="search" autocomplete="off">
                    {{ csrf_field() }}
...
@endforeach
          ...
          <br>
                        ...
                        <a class="btn btn-success" href="{{ url('/' . ($page = 'printBest_selling_products').'/'.$branch_id.'/'.$startat.'/'.$endat) }}"> {{__('home.print')}}</a>
</div>
<br>
                    @endif
                </div>
