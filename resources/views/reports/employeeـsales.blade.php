    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="{{ url(Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale().'/'. ($page = 'employeeSalesSearch')) }}" method="POST" role="search" autocomplete="off">
                    {{ csrf_field() }}
...
<div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
    <p class="mg-b-10">     {{__('report.Enter_employeeـname')}}  </p>
...
<a class="btn btn-success" href="{{ url('/' . ($page = 'printReportemployeeSales').'/'.$userId.'/'.$startat.'/'.$endat) }}"> {{__('home.print')}}</a>
</div>
@endif
                </div>
