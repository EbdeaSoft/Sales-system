    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="{{ url(Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale().'/'. ($page = 'search_Requestـoffersـfromـsuppliers')) }}" method="POST" role="search" autocomplete="off">
                    {{ csrf_field() }}
...
<span class="text-danger">{{__('users.branch')}}   :  {{$invoice->user->branch->name}}
@endif
</span>
<br>
...
<a class="btn btn-success" href="{{ url('/' . ($page = 'print_report_order_from_supplier').'/'.$supplierId.'/'.$startat.'/'.$endat) }}"> {{__('home.print')}}</a>
</div>
@endif
                </div>
