...
<div class="row">
        ...
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="{{ url(Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale().'/'. ($page = 'product_sales')) }}" method="POST" role="search" autocomplete="off">
                    {{ csrf_field() }}
...
<div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
    ...
    <div class="table-responsive hoverable-table">
                    <table class="table table-hover" id="example1" data-page-length='20' style=" text-align: center;">
    ...
    <thead>
                        ...
                        <span class="border-bottom-0"> {{__('home.total')}} {{$totalprice}}</span>
                               <br>
                                <span class="border-bottom-0"> {{__('home.addedValue')}} {{$totaladdedvalue}}</span>
                        <div class="d-flex justify-content-center">

<a class="btn btn-success" href="{{ url('/' . ($page = 'printReportProductSales').'/'.$branch_Id.'/'.$productId.'/'.$startat.'/'.$endat) }}"> {{__('home.print')}}</a>
</div>
<br>
                    @endif
