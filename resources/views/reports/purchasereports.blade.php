    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="{{ url(Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale().'/'. ($page = 'purchasereports')) }}" method="POST" role="search" autocomplete="off">
                    {{ csrf_field() }}
...
<a class="btn btn-success" href="{{ url('/' . ($page = 'print_purchasereports').'/'.$productId.'/'.$startat.'/'.$endat) }}"> {{__('home.print')}}</a>
</div>
<br>
                    @endif
                </div>
