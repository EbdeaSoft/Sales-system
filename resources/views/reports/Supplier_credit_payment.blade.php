...
@section('title')
{{__('report.Supplier credit payment')}}@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">{{__('report.Supplier credit payment')}}
    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="{{ url(Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale().'/'. ($page = 'Supplier_credit_payment')) }}" method="POST" role="search" autocomplete="off">
                    {{ csrf_field() }}
...
<a class="btn btn-success" href="{{ url('/' . ($page = 'print_Supplier_credit_payment').'/'.$supplierId.'/'.$startat.'/'.$endat) }}"> {{__('home.print')}}</a>
</div>
@endif
                </div>
